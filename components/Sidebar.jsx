        ...
        <div className='flex flex-row items-center'>
          <Link href='/'>
            <div className='flex align-middle justify-between items-center'>
              ...
              <p className='text-center mx-8 my-8 text-white text-lg font-bold lg:flex md:flex phone:hidden'>Radar da Soja</p>
            </div>
          </Link>
        </div>
        <div className='flex flex-col place-items-start'>
            <Link href='/'>
              <div className='my-4 p-3 flex align-middle justify-between items-center'>
                ...
                <p className='mx-4 text-white lg:flex md:flex phone:hidden'>Dashboard</p>
              </div>
            </Link>
            <Link href='/news'>
              <div className='my-4 p-3 flex align-middle justify-between items-center'>
                <Image src="/news-icon.svg" alt="Radar da Soja" width={20} height={20} />
                <p className='mx-4 text-white lg:flex md:flex phone:hidden'>Notícias</p>
              </div>
            </Link>
            <Link href='/for-you'>
              <div className='my-4 p-3 flex align-middle justify-between items-center'>
                <Image src="/for-you-icon.svg" alt="Radar da Soja" width={20} height={20} />
                <p className='mx-4 text-white lg:flex md:flex phone:hidden'>Para você</p>
              </div>
            </Link>
        </div>
        {/* <button>
